...
int main() {
    Vector v, x;
    int pecas[5][3] = {{1144, 1200, 1200}, {800, 630, 750}, {2345, 2400, 2567}, {1789, 1876, 1654}, {3456, 3214, 2999}};
  ...
  //  imprimirVetor(v);
   ...
   // imprimirVetor(x);
	...
	//testHuffmanRosetta();
	testHuffmanAlternativeRosetta();

    histograma(pecas, 5);/* protótipo */
