...
print 2 ** 8 # Eleva a uma potencia
print 'the bridge side ' + 'of life' # + significa concatenasciaum
import sys
print sys.platform
num1 = 0
num2 = 0
...
if next == gabarito:
	...
	print 'Isso eh uma operasciaum aritmehtica!'
elif next < gabarito:
	print 'Eh maior que isso!'
elif next > gabarito:
	print 'Eh menor que isso!'
else:
	print 'Errado!'
